(() => {
  const ensureStylesheet = () => {
    ...
    link.rel = 'stylesheet';
    link.href = '/assets/css/clarity-timeline-v1.css?v=2';
        ...
        <div class="clarity-timeline__viewport" aria-label="Comment le manque de clarté complique progressivement la décision du client">
          <div class="clarity-timeline__stage">
            <svg class="clarity-timeline__thread" viewBox="0 0 1200 354" preserveAspectRatio="none" aria-hidden="true">
              ...
              <path fill="none" class="clarity-timeline__thread-shadow" d="M 20 184 C 100 157 170 211 245 179 S 385 157 455 190 S 585 219 660 177 S 805 151 875 194 S 1010 224 1080 181 S 1150 157 1180 174"/>
              <path fill="none" id="clarityTimelinePath" class="clarity-timeline__thread-fiber" d="M 20 184 C 100 157 170 211 245 179 S 385 157 455 190 S 585 219 660 177 S 805 151 875 194 S 1010 224 1080 181 S 1150 157 1180 174"/>
              <path fill="none" class="clarity-timeline__thread-strand" d="M 20 184 C 100 157 170 211 245 179 S 385 157 455 190 S 585 219 660 177 S 805 151 875 194 S 1010 224 1080 181 S 1150 157 1180 174"/>
              <path fill="none" class="clarity-timeline__thread-soft" d="M 52 189 C 140 169 180 198 272 180 M 425 191 C 520 206 573 205 680 177 M 842 190 C 931 213 1003 208 1102 177"/>
              <g>
